 ...
 *
 * Only referralId is required (see minimal.tsx for the simplest embed). This
 ...
 * page, see parent-wallet.tsx. The dynamic import with ssr:false keeps the
...
import type { ChromeOptions, ThemeOptions } from '@atom-circuit/embed-sdk';
