# Atom Circuit Next.js examples (JavaScript)

A runnable Next.js (App Router) app demonstrating each way to embed the Atom
Circuit swap widget, in plain JavaScript. Each file under `examples/` is an
independent integration. `app/` is the dev harness that mounts them; it is not
